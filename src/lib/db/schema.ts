...
export const posts = pgTable(
  ...
  (table) => ({
    feedIdIndex: index("idx_posts_feed_id").on(table.feedId),
    publishedAtIndex: index("idx_posts_published_at").on(table.publishedAt),
    feedIdPublishedAtIndex: index("idx_posts_feed_id_published_at").on(
      table.feedId,
      table.publishedAt
    ),
  })
